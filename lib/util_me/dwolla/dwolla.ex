defmodule UtilMe.Dwolla.Dwolla do
alias UtilMe.Config, as: Config
# alias UtilMe.Accounts
# alias Decimal, as: D
import Logger
  ...
  #   request = UtilMe.Payment.get_payment_request_full!(request_id)
  #   headers = ["Authorization": "Bearer #{Config.token}",
  #   "Content-Type": "application/vnd.dwolla.v1.hal+json",
  #   "Accept": "application/vnd.dwolla.v1.hal+json"]
  ...
  #   dest = UtilMe.Repo.preload(request.expense_instance, [expense: :owner])
  ...
  #       {:ok, req} = UtilMe.Payment.update_payment_request(request, %{"transaction_id" => id, "paid_at" => DateTime.utc_now })
  #       req
  #     {:error, %HTTPoison.Error{reason: reason}} ->
  #       IO.inspect(reason)
  #   end
